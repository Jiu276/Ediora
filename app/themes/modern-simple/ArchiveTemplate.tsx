...
export default function ModernSimpleArchiveTemplate({ loading, archiveGroups, yearStats, config }: ArchiveTemplateProps) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: config.colors.background }}>
      <header style={{ 
        ...
        <Title level={1} style={{ margin: 0, color: '#fff', fontWeight: 300, letterSpacing: '4px', fontSize: 32 }}>
          IRIDIUM
        </Title>
      </header>
