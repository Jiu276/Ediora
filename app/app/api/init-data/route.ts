...
export async function POST(_request: NextRequest) {
  try {
    ...
    const themes = [
      ...
      { id: 'travel-blog', name: 'Travel Blog', slug: 'travel-blog', description: 'A clean and airy layout for travel stories and visuals.', isActive: false },
      { id: 'modern-magazine', name: 'Modern Magazine', slug: 'modern-magazine', description: 'A modern magazine look with layered readability.', isActive: false },
      { id: 'modern-simple', name: 'Modern Simple', slug: 'modern-simple', description: 'A modern simple design optimized for long reads.', isActive: false },
      { id: 'lifestyle-daily', name: 'Lifestyle Daily', slug: 'lifestyle-daily', description: 'A lightweight daily lifestyle style for easy reading.', isActive: false },
      { id: 'zen-blog', name: 'Zen Blog', slug: 'zen-blog', description: 'A calm whitespace-forward style that highlights the content.', isActive: false },
    ]
