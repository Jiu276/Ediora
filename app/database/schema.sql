...
CREATE TABLE IF NOT EXISTS article_links (
  ...
  url VARCHAR(2000) NOT NULL COMMENT '超链接URL',
  created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  deleted_at DATETIME(3) NULL COMMENT '软删除时间',
  INDEX idx_article_id (article_id),
...
('1', '默认主题', 'default', '现代简洁风格，适合通用博客', FALSE, NOW(3), NOW(3)),
...
('6', 'Bootstrap Blog', 'bootstrap-blog', 'Bootstrap 5 风格', FALSE, NOW(3), NOW(3)),
('7', '综合类博客', 'comprehensive', '综合类博客主题', FALSE, NOW(3), NOW(3)),
('8', '多功能杂志', 'magazine-multi', '杂志风格多功能', FALSE, NOW(3), NOW(3)),
('9', '简约休闲生活', 'minimal-lifestyle', '简约休闲生活主题', FALSE, NOW(3), NOW(3)),
