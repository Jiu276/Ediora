...
function buildMediumEnglishFallbackArticle(articleTitle, minPlainChars = 5500) {
  ...
  let i = 1
  while (plainLen(html) < minPlainChars && i <= 6) {
...
module.exports = { buildMediumEnglishFallbackArticle, plainLen }
