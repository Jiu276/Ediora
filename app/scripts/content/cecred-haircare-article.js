...
const IMAGES = [
  ...
  {
    url: 'https://images.unsplash.com/photo-1519699047748-de8e457a634e?w=1200&q=80&auto=format&fit=crop',
    alt: 'Healthy natural textured hair with moisture and shine',
    caption: 'Cécred builds for every texture—from straight to coily—not one “ideal” hair type.',
    source: 'unsplash',
  },
  {
    url: 'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&cs=tinysrgb&w=1200',
    alt: 'Shampoo lather massaged into hair during a cleansing wash',
    caption: 'A short cleanse-and-condition ritual you will repeat beats a shelf of products you never finish.',
    source: 'pexels',
  },
  {
    url: 'https://images.unsplash.com/photo-1712641966810-611ff1503c6d?w=1200&q=80&auto=format&fit=crop',
    alt: 'Woman gently drying curly hair with a diffuser at home',
    caption: 'Protect wet hair before heat—moisture and shielding come first, styling second.',
    source: 'unsplash',
  },
]
